...
ActiveRecord::Schema.define(version: 20151019205347) do
  ...
  add_index "contacts", ["email", "user_id"], name: "by_user_email", unique: true, using: :btree
  ...
  add_index "groupings", ["group_id", "contact_id"], name: "index_groupings_on_group_id_and_contact_id", unique: true, using: :btree
